...
(function($) {
  ...
  function defaultRowWriter(rowIndex, record, columns, cellWriter) {
    ...
    return '<tr oncontextmenu="contextMenu(event)" class="table-row">' + tr + '</tr>';
  };
  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      ...
      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        ...
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " تا " + bounds[1] + "</span> از ";
      } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
        text += recordsShown + " از ";
      }
      text += recordsQueryCount + " " + 'حواله';
      if (recordsQueryCount < recordsTotal) {
        text += " ( تعداد کل حواله ها :" + recordsTotal + " )";
      }
  ...
  function InputsSearch(obj, settings) {
    ...
    this.create = function() {
      var $search = $('<input />', {
          ...
          $searchSpan = $('<div style="width:50%"></div>', {
  ...
  function PaginationLinks(obj, settings) {
    ...
    this.create = function() {
      ...
      pageLinks += '<li><span>صفحه :</span></li>';
