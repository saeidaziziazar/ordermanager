        ...
        {!! Form::open(['action' => ['YearController@update', $year->id], 'method' => 'PUT', 'autocomplete' => 'off']) !!}
            <div class="form-group">
                <div class="input-group">
                    ...
                    {!! Form::text('name', $year->name, ['class' => 'form-control']); !!}
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    {!! Form::text('startdate', $year->start, ['class' => 'form-control', 'id' => 'date']); !!}
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    {!! Form::text('enddate', $year->end, ['class' => 'form-control', 'id' => 'date']); !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::submit('ویرایش سال مالی', ['class' => 'btn btn-primary']); !!}
            </div>
        {!! Form::close() !!}
    </div>
@endsection
